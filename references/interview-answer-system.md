...
Before writing an answer, record internally:
...
Answer the intent, not merely the literal wording.
...
Never make a hypothetical method sound historical.

## Write candidate-ready speech

Use:

```text
Direct answer → concrete situation → what I did/thought → result or learning → relevance
```

- Lead with value rather than a disclaimer.
- Use the candidate's actual seniority, vocabulary, and communication style; do not invent personality.
- Prefer one concrete story over a list of transferable abstractions.
- Use ordinary verbs and Chinese unless the industry term is genuinely how practitioners speak.
- Mention a limitation once, only when it answers the question or prevents a misleading claim.
...
- process disclaimers such as “本次材料没有验证”, “候选人陈述”, “如果无法解释我就不使用”, or “我不会把它说成…”;
- coaching stage directions such as “安全说法”, “面试时必须强调”, or “这里要收窄 claim”;
...
> 这个经验能迁移到达人筛选中的内容机制判断，但我不会把它说成美区 TikTok 投放经验。

Human:

> 我做内容时最常做的一件事，是先拆同类账号为什么能让用户停下来，再用发布后的阅读和互动调整选题。到了达人筛选里，我也会先看创作者稳定使用的内容机制，而不是只看粉丝数。

Robotic:

> 这些数字在本次材料里没有原始后台和定义，如果无法解释，我就不使用精确值。

Human when asked about results:

> 当时我主要看阅读、互动和线索质量来调选题。具体数字我会按后台口径说明，我更想强调的是，我能根据结果找到下一轮该改什么。

Robotic:

> 我要明确边界：我没有独立谈费用、合同、交付、使用权或复投。

Human:

> 那次合作里我主要负责前期需求沟通和推进。商务条款由项目负责人把关，所以我熟悉前期怎么找到合作理由，但正式报价和合同谈判是我接下来要补的部分。

## Three-round stress test

1. **Ownership:** What exactly did you do, decide, and hand off?
...
Read every candidate answer aloud and ask:

- Would a real candidate at this seniority say this unprompted?
